...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Widget _buildMediaDevicesDropDown(String labelText, List<MediaDevice> dvcList,
      int selIndex, OnChangedCallback onChanged) {
    return ButtonTheme(
  ...
  Widget _buildPlayoutDevicesDropDown(DevicesModel devices) {
    return _buildMediaDevicesDropDown('Playout device:', devices.playout,
        devices.playoutIndex, onSetPlayoutDevice);
  }

  Widget _buildRecordingDevicesDropDown(DevicesModel devices) {
    return _buildMediaDevicesDropDown('Recording device:', devices.recording,
        devices.recordingIndex, onSetRecordingDevice);
  }

  Widget _buildVideoDevicesDropDown(DevicesModel devices) {
    return _buildMediaDevicesDropDown(
        'Video device:', devices.video, devices.videoIndex, onSetVideoDevice);
  }
